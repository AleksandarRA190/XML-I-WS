...
public class Reservation {
    ...
    public Reservation(ReservationDTO res) {
    	...
    	this.deleted = false;
    	this.userDto = new User(res.getGuest());
    	this.fromDate = MyTypeConverter.localDateTimeToXMLGregorianCalendar(res.getFromDateTime());
    	this.toDate = MyTypeConverter.localDateTimeToXMLGregorianCalendar(res.getToDateTime());
    }
