 ...
 *       &lt;sequence&gt;
 *         &lt;element name="accommodations" type="{http://www.projectXml.com/accommodation}accommodation" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetAccommodationsResponse {
    ...
    protected List<AccommodationDTO> accommodations;
    ...
    public List<AccommodationDTO> getAccommodations() {
        if (accommodations == null) {
            accommodations = new ArrayList<AccommodationDTO>();
        }
