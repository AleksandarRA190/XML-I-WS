...
public class AccommodationEndpoint {
	...
	public GetAccommodationsResponse processGetAccommodationsRequest(@RequestPayload GetAccommodationsRequest request) {
		...
		AccommodationsDTO asDTO = restTemplate.getForObject("http://accommodation-service/accommodation",
				AccommodationsDTO.class);
	...
	public GetAccommodationResponse processGetAccommodationRequest(@RequestPayload GetAccommodationRequest request) {
		...
		Accommodation a = restTemplate.getForObject("http://accommodation-service/accommodation/" + request.getId(),
				Accommodation.class);
	...
	@ResponsePayload
	public GetAccommodationByUserResponse processGetAccommodationByUserRequest(
			@RequestPayload GetAccommodationByUserRequest request) {
		GetAccommodationByUserResponse response = new GetAccommodationByUserResponse();

		Accommodation a = restTemplate.getForObject(
				"http://accommodation-service/accommodation/byUser/" + request.getUsername(), Accommodation.class);
		response.setAccommodation(a);
	...
	public AddAccommodationResponse processAddAccommodationRequest(@RequestPayload AddAccommodationRequest request) {
		...
		Accommodation a = restTemplate.postForObject("http://accommodation-service/accommodation", requestHeader,
				Accommodation.class);
		response.setAccommodation(a);
	...
	public void processUpdateAccommodationRequest(@RequestPayload UpdateAccommodationRequest request) {
		...
		restTemplate.put("http://accommodation-service/accommodation/" + request.getAccommodation().getId(),
				requestHeader);
	}
	...
	public void processRemoveAccommodationRequest(@RequestPayload RemoveAccommodationRequest request) {
		restTemplate.delete("http://accommodation-service/accommodation/" + request.getId());
	}
}
