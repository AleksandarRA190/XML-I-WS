...
public class NewAgentFrame extends JFrame {
	...
	public void initComponents() {
		...
		this.businessLabel = new JLabel("Business reg. number: ", JLabel.TRAILING);
		this.businessField = new JTextField(10);
		this.businessLabel.setLabelFor(businessField);

		this.businessLabel.setPreferredSize(labelDim);
		this.businessField.setPreferredSize(fieldDim);

		this.leftPanel.add(businessLabel);
		this.leftPanel.add(businessField);
		...
		this.okButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (validation() && validationPassword()) {
					...
					newAgent.setName(nameField.getText());
					newAgent.setLastname(lastnameField.getText());
					newAgent.setUsername(usernameField.getText());
					newAgent.setEmail(emailField.getText());
					newAgent.setBlocked(false);
					newAgent.setBussinesRegistrationNumber(Long.parseLong(businessField.getText()));
